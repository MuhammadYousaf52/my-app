            ...
            <motion.div
                ...
                <form onSubmit={handleSubmit}>
                    <motion.div
                        ...
                        <button onClick={() => signIn("google", { callbackUrl: '/notes' })} className="cursor-pointer w-full py-2 sm:py-3 rounded-xl bg-[#797CE9] text-white font-semibold flex items-center justify-center gap-2 sm:gap-3 hover:bg-[#6366F1] transition-colors duration-300 text-sm sm:text-base">
